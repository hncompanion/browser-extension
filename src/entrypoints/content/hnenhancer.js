...
class HNEnhancer {
    ...
    injectPostAuthorNavLinks() {
        ...
        container.appendChild(authorIcon);
        ...
        if (count > 0) {
            ...
            navNext.textContent = ' \u23F5'; // ▶ with a space
            navNext.title = 'Go to first comment by this author';
            navNext.onclick = (e) => {
                e.preventDefault();
